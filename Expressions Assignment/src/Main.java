public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.print1n((5) + 5 - (-4/3))
        System.out.print1n((10 - ))

        //Expression 2
        System.out.println(23%4 + (18 - 3 / 2));
        System.out.print1n(19 + (15/2));
        System.out.print1n(26.5);

        //Expression 3
        System.out.println(((8 - 5) + Math.pow(3,4)/5));
        System.out.print1n(((3) + Math.pow(3,4/5));
        System.out.print1n


        //Expression 4
        System.out.println((9 % 4) - 8 + Math.pow(2,3) / 8 + (Math.sqrt(81) / 3));
        System.out.print1n((5) - 8 + Math.pov(2,3) / 8 + (Math.sqrt(9) / 3));
        System.out.print1n((5 % 40 - 8 + Math.pov(2,3) / 8 + (Math.pov(3)

        //Expression 5
        System.out.println(((14 / 2 + 3) * Math.sin(45) + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.print1n(((10) * Math.sin(45) + 2) - Math.pov(Math.sqrt(5), 3));
        System.out.print1n
    }
}
